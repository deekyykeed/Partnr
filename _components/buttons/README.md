...
Path is relative to the file you're linking from. From a client site at `Clients/[Name]/website/index.html`:

```html
<link rel="stylesheet" href="../../../_components/buttons/button.css">
```
...
- **Global change** (every site updates) → edit `_components/buttons/button.css`
